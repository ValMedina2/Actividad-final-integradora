...
<html>
    ...
    <body style="background-color:rgba(75, 9, 75, 0.529);">
        <h1 style="color: rgb(70, 12, 70); margin-top: 60px; margin-left:120px;">LivFITNESS</h1>
        <h2 style="color: honeydew; margin-left: 120px;">Listado de Socios</h2>
        
        
        <div class="container">
            <div class="row"> 
                <div class="d-grid"></div>  
                    <a class="btn btn-dark col-8 m-4" href="SociosController?accion=nuevo">Agregar Socio</a>
                </div>
