...
<html>
    ...
    <body style="background-color:rgba(75, 9, 75, 0.529);">        
        <div class="container" >
            <h1 class="text-center" style="color: white; margin-top: 60px;">Modificar Socio</h1>
                <div class="row" >
                    <%
		    ...
		    %>
                    <form class="p-5" method="POST" action="SociosController?accion=actualizar">
                         <div class="mb-2">
                            <b><label for="id" class="form-label" >id</label></b>
                        ...
                        <button type="submit" class="btn btn-dark col-8" style="margin-left: 200px; margin-bottom: 60px;" >Modificar </button>
